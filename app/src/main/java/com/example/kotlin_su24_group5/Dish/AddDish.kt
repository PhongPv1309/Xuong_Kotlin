...
import com.example.kotlin_su24_group5.DetailProduct
import com.example.kotlin_su24_group5.navDonHang
...
fun getAddDish(name: String, modifier: Modifier = Modifier){
    ...
    Column (
       ...
       MenuBox(Mon, LuaChon) { Mon = it }
       MenuBox(LoaiMon, LuaChonLoaiMon) { LoaiMon= it }
